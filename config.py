...
TUT_VID = os.environ.get("TUT_VID","https://t.me/How_To_Download_From_World/14")
...
#custom caption 
CUSTOM_CAPTION = os.environ.get("@Cultured_Galaxy", None)
...
ADMIN_LIST = os.environ.get("ADMINS", "7498496743").split()
